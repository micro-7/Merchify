...
urlpatterns = [
    ...
    path('product/custom/<int:id>', views.custom_product, name='cproduct'),
    ...
    path('checkout/custom/product/<int:id>/', views.custom_checkout, name='custom_checkout'),
    ...
    path('create-custom-checkout-session/',views.create_custom_checkout_session,name='create_checkout_session'),
